...
public class QueryDB {
    public static String FIND_ALL = " SELECT imageoftheday.id, imageoftheday.author, imageoftheday.feedback,imageoftheday.likeComment,imageoftheday.startDate,scoringscale.idSco,scoringscale.name FROM image_day.imageoftheday\n" +
